        ...
        Joker = {
            ...
            j_kino_big_short = {
                ...
                text = {
                    ...
                    "your money & {C:green}#5# in #4# chance to",
                    "{C:attention}Bust{} instead (This chance",
            ...
            j_kino_children_of_the_corn = {
                ...
                text = {
                    ...
                    "in hand and gain {C:chips}+#2#{} Chips for each",
            ...
            j_kino_doctor_who = {
                ...
                text = {
                    "If in your {C:attention}Active slot{}",
            ...
            j_kino_megalopolis = {
                name = "Megalopolis",
                text = {
                    "Each scored {C:clubs}Clubs{} gives {C:chips}+#2#{} Chips",
                    "for each other scoring {C:clubs}Clubs{}"
                }
            },
            j_kino_memento = {
                name = "Memento",
            ...
            j_kino_modern_times = {
                ...
                text = {
                    ...
                    "and a {C:green}#2# in #4#{} chance to",
                    "be destroyed"
                }
            },
            j_kino_moneyball = {
            ...
            j_kino_secretary = {
                name = "Secretary",
                text = {
                    "Each scored {C:spades}Spades{} gives {C:chips}+#2#{} Chips",
            ...
            j_kino_turner_and_hooch = {
                ...
                text = {
                    ...
                    "\n",
                    "{C:attention}Active{}: {C:mult}+#4#{} Mult per",
                    "Evidence consumed",
            ...
            j_kino_zodiac = {
                ...
                text = {
                    ...
                    "by {C:attention}#1#%{} per stack used",
