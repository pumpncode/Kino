SMODS.Joker {
    ...
    loc_vars = function(self, info_queue, card)
        ...
        return {
            vars = {
                ...
                card.ability.extra.next_card_rank,
                card.ability.extra.next_card_suit,
    ...
    calculate = function(self, card, context)
        ...
        if context.hand_drawn and not context.blueprint and not context.repetition then
            ...
            card.ability.extra.next_card_rank = card.ability.extra.next_card.rank
            card.ability.extra.next_card_suit = card.ability.extra.next_card.base.suit
        end
